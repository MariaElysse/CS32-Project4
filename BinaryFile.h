//
// Created by jeremy on 3/6/16.
//

#ifndef PROJECT4_BINARYFILE_H
#define PROJECT4_BINARYFILE_H
...
template<typename T>
struct False : false_type {
};

template<typename T>
struct is_string {
    enum {
        value = is_same<string, typename remove_cv<T>::type>::value
    };
};
